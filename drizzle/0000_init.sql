...
CREATE TABLE "ledger_events" (
	...
	CONSTRAINT "ledger_events_server_seq_unique" UNIQUE("server_seq")
);
--> statement-breakpoint
...
CREATE TABLE "reminder_dispatches" (
	...
	CONSTRAINT "reminder_dispatches_user_id_prayer_day_kind_pk" PRIMARY KEY("user_id","prayer_day","kind")
);
--> statement-breakpoint
...
ALTER TABLE "ledger_events" ADD CONSTRAINT "ledger_events_user_id_user_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."user"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "ledger_events_user_seq_idx" ON "ledger_events" USING btree ("user_id","server_seq");